...
def create_server_connection(db_name = "database", show_success = True):
...
def select_from_table(connection, table_name, arguments, show_results = True, show_execution_success = True):
...
def select_all_from_table(connection, table_name, show_results = True, show_execution_success = True):
...
def delete_from_table(connection, table_name, condition, show_execution_success = True):
    ...
    # this function deletes all tuples from a table in a MySQL database
